...
let button_config  = document.getElementById('configButton')
...
function configDevices() {
    ipcRenderer.send('configDevices')
    statusConsole("sending config")
}
...
button_config.addEventListener('click', configDevices)
